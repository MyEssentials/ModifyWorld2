...
@Mod(modid = "Modifyworld2", name = "Modifyworld2", version = "1.5.0.0")
public class Modifyworld2 {
	...
	protected BaseListener[] listeners = new BaseListener[] { new PlayerListener(), new EntityListener(), new BlockListener() };
